...
## I know this looks like the starter code, but I will delete this before implementation, I just don't want to lose these palettes quite yet
...
#
# mandelbrotPalette = ['#89ff00', '#a4f817', '#baf12e', '#ccec43', '#d9e758', '#e3e46b', '#e1d97e',
